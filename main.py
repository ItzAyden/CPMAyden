...
def load_player_data(cpm):
    ...
    if response.get('ok'):
        ...
        if 'floats' in data and 'localID' in data and 'money' in data and 'coin' in data:
            ...
            print(Colorate.Horizontal(Colors.red_to_yellow, '======================[ Player Information ]======================'))
...
def load_key_data(cpm):
    ...
    print(Colorate.Horizontal(Colors.red_to_yellow, '======================[ Secret Access Key ]======================='))
...
if __name__ == "__main__":
    ...
    while True:
        ...
        while True:
            ...
            print(Colorate.Horizontal(Colors.red_to_yellow, '[01]  Change money            1.000K'))
            print(Colorate.Horizontal(Colors.red_to_yellow, '[02]  Change coin             3.500K'))
            print(Colorate.Horizontal(Colors.red_to_yellow, '[03]  King Rank                4.000K'))
            print(Colorate.Horizontal(Colors.red_to_yellow, '[04]  Custom ID                3.500K'))
            print(Colorate.Horizontal(Colors.red_to_yellow, '[05]  Change name               1.00'))
            print(Colorate.Horizontal(Colors.red_to_yellow, '[06]  Change rainbow name      1.00'))
            print(Colorate.Horizontal(Colors.red_to_yellow, '[07]  Number Plates            2.000K'))
            print(Colorate.Horizontal(Colors.red_to_yellow, '[08]  Delete account           FREE'))
            print(Colorate.Horizontal(Colors.red_to_yellow, '[09]  Account Register         FREE'))
            print(Colorate.Horizontal(Colors.red_to_yellow, '[10]  Delete friends list       5.00'))
            ...
            print(Colorate.Horizontal(Colors.red_to_yellow, '[13]  Inject get all cars       2.000K'))
            ...
            print(Colorate.Horizontal(Colors.red_to_yellow, '[20]  Unlock Wheels            4.000K'))
            print(Colorate.Horizontal(Colors.red_to_yellow, '[21]  Unlock Animations        2.000K'))
            print(Colorate.Horizontal(Colors.red_to_yellow, '[22]  Unlock Equipaments M     3.000K'))
            print(Colorate.Horizontal(Colors.red_to_yellow, '[23]  Unlock Equipaments F     3.000K'))
            print(Colorate.Horizontal(Colors.red_to_yellow, '[24]  Change race win           1.000K'))
            print(Colorate.Horizontal(Colors.red_to_yellow, '[25]  Change race lose          1.000K'))
            print(Colorate.Horizontal(Colors.red_to_yellow, '[26]  Clone Account            5.000K'))
            print(Colorate.Horizontal(Colors.red_to_yellow, '[27]  Glitch car               2.500K'))
            print(Colorate.Horizontal(Colors.red_to_yellow, '[28]  Custom Angle             1.500K'))
            print(Colorate.Horizontal(Colors.red_to_yellow, '[29]  Chrome All Cars           3.500K'))                
            print(Colorate.Horizontal(Colors.red_to_yellow, '[0]   Exit tools'))
        ...
        break
            ...
            elif service == 29: # Chrome All Cars
