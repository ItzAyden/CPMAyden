...
def banner(console):
    ...
    print(Colorate.Horizontal(Colors.red_to_yellow, ' CPM Tools Version 2.5.8.9 || Author https://t.me/cpmayden_channel'))
    print(Colorate.Horizontal(Colors.red_to_yellow, '=================================================================='))
    print(Colorate.Horizontal(Colors.red_to_yellow, '\t         Please Logout From CPM Before Using This Tool'))
    print(Colorate.Horizontal(Colors.red_to_yellow, f' ‌          Telegram : @{__CHANNEL_USERNAME__} Group @{__GROUP_USERNAME__}'))
    print(Colorate.Horizontal(Colors.red_to_yellow, '=================================================================='))
