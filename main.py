...
def banner(console):
    ...
    console.print(f"[bold green]CPM Tools Version 2.5.8.9 || Author https://t.me/cpmayden_channel")
    console.print(f"[bold green]==================================================================")
    console.print(f"[bold green]         Please Logout From CPM Before Using This Tool")
    console.print(f"[bold green] ‌          Telegram : @{__CHANNEL_USERNAME__} Group @{__GROUP_USERNAME__}")
    console.print(f"[bold green]==================================================================")
...
def load_player_data(cpm):
    ...
    if response.get('ok'):
        ...
        if 'floats' in data and 'localID' in data and 'money' in data and 'coin' in data:
            ...
            console.print(f"[bold white]======================[ Player Information ]======================")
            
            console.print(f"[bold green]>> Name   : {(data.get("Name") if "Name" in data else "UNDEFINED")}.")
                
            console.print(f"[bold green]>> User ID: {data.get("localID")}.")
            
            console.print(f"[bold green]>> Money  : {data.get("money")}.")
            
            console.print(f"[bold green]>> Coin   : {data.get("coin")}.")
...
def load_key_data(cpm):
    ...
    console.print(f"[bold white]======================[ Secret Access Key ]=======================")
    
    console.print(f"[bold green]>> Access Key : {data.get("access_key")}.")
    
    console.print(f"[bold green]>> Telegram ID: {data.get("telegram_id")}.")
    
    console.print(f"[bold green]>> Balance $  : {(data.get("coins") if not data.get("is_unlimited") else "Unlimited")}.")
...
def load_client_details():
    ...
    data = response.json()
    console.print(f"[bold white]===========================[ Location ]===========================")
    console.print(f"[bold green]>> Ip Address : {data.get("query")}.")
    console.print(f"[bold green]>> Location   : {data.get("city")} {data.get("regionName")} {data.get("countryCode")}.")
    console.print(f"[bold green]>> Country    : {data.get("country")} {data.get("zip")}.")
    console.print(f"[bold white]=============================[ MENU ]=============================")
